...
def get_top_articles(topic, api_key, article_count=3):
    ...
    params = {
        'q': topic, 'sources': sources, 'language': 'en',
...
def generate_html(article_data):
    # Le chemin doit être relatif au dossier où la fonction s'exécute
...
def handler(event, context):
    print("--- Aurore démarre sa mission (version Fichier Unique) ---")
